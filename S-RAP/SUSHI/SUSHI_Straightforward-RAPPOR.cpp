...
const int pai_num = 100 ;				    		//项目数为n的平方，1=>1, 2=>4, 3=>9, 4=>16, 5=>25, 6=>36, 7=>49, 8=>64, 9=>81, 10=>100 
const int top_num = 10 ;								//前五个的排序 
...
void Init()
{
	...
	fd = fopen ("dataset\\output_RR_item-10.txt","w");
	jgl = fopen ("dataset\\output_statistics_item-10.txt","w");
	bordaxu = fopen ("dataset\\output_Final-Borda_item-10.txt","a");
}

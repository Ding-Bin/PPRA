...
const int pai_num = 40320 ;				    	//5的全排列个数  5!=120; 6!=720; 7!=5040; 8!=40320; 9!=362880; 10!=3628800	——可设置
...
void open()
{
	ar = fopen("dataset\\input_all-rank-of-8.txt","r");
	ss = fopen("dataset\\input_sushi3a.5000.8-result.txt","r");
	bordaxu = fopen ("dataset\\Output_Naive-RAPPOR_User'num-5000_item-8_Epsilon-1.0_for-1000.txt","a");	
}

...
void open()
{
	ss = fopen("dataset\\input_sushi3a.5000.10-result.txt","r");
	bordaxu = fopen ("dataset\\Output_Straightforward-RAPPOR_User'num-5000_item-10_Epsilon-0.01_for-1000_1.txt","a");
}

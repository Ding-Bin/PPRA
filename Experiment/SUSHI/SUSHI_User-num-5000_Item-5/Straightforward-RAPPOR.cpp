...
const double epsilon = 0.5 ;						//ε的值初始化 										——可设置
...
void open()
{
	ss = fopen("dataset\\input_sushi3a.5000.5-result.txt","r");
	bordaxu = fopen ("dataset\\Output_Straightforward-RAPPOR_User'num-5000_item-5_Epsilon-0.5_for-1000.txt","a");
}

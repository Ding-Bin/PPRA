...
const int pai_num = 81 ;				    		//项目数为n的平方，1=>1, 2=>4, 3=>9, 4=>16, 5=>25, 6=>36, 7=>49, 8=>64, 9=>81, 10=>100 ——可设置
const int top_num = 9 ;								//前五个的排序 										——可设置
...
void open()
{
	ss = fopen("dataset\\input_sushi3a.5000.9-result.txt","r");
	bordaxu = fopen ("dataset\\Output_Straightforward-RAPPOR_User'num-5000_item-9_Epsilon-0.1_for-1000_1.txt","a");
}

...
void open()
{
	ss = fopen("dataset\\input_Jester-1-user_num-15000_item-9.txt","r");
	bordaxu = fopen ("dataset\\Output_Straightforward-RAPPOR_User'num-15000_item-9_Epsilon-1.0_for-1000.txt","a");
}

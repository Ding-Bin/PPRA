...
const int pai_num = 3600 ;				    			//项目数为n的平方，1=>1, 2=>4, 3=>9, 4=>16, 5=>25, 6=>36, 7=>49, 8=>64, 9=>81, 10=>100 ——可设置
const int top_num = 60 ;								//前五个的排序 										——可设置
...
void open()
{
	ss = fopen("dataset\\input_Jester-1-user_num-15000_item-60.txt","r");
	bordaxu = fopen ("dataset\\Output_Straightforward-RAPPOR_User'num-15000_item-60_Epsilon-0.05_for-1000.txt","a");
}

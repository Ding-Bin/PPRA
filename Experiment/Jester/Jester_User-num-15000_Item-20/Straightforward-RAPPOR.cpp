...
const int pai_num = 400 ;				    			//项目数为n的平方，1=>1, 2=>4, 3=>9, 4=>16, 5=>25, 6=>36, 7=>49, 8=>64, 9=>81, 10=>100 ——可设置
const int top_num = 20 ;								//前五个的排序 										——可设置
const int jingdu = 1000 ;							//百分比精度，100代表两位，1000代表三位，以此类推 	——可设置
const double epsilon = 0.01 ;						//ε的值初始化 										——可设置
...
void open()
{
	ss = fopen("dataset\\input_Jester-1-user_num-15000_item-20.txt","r");
	bordaxu = fopen ("dataset\\Output_Straightforward-RAPPOR_User'num-15000_item-20_Epsilon-0.01_for-1000_1.txt","a");
}

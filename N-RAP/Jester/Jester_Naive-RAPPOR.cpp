...
const int pai_num = 2 ;				        //全排列个数  5!=120; 6!=720; 7!=5040; 8!=40320; 9!=362880; 10!=3628800(可设置)
...
void Init()
{
	...
	ar = fopen("dateset\\input_all-rank-of-2.txt","r");
	...
	fd = fopen ("dataset\\output_RR_item-2.txt","w");
	jgl = fopen ("dataset\\output_statistics_item-2.txt","w");
	bordaxu = fopen ("dataset\\output_Final-Borda_item-2.txt","a");
...
{	
	int c = 0;														//用户编号 
	ss = fopen("dataset\\input_XuHao_Top-2-user_num-15000.txt","r");
